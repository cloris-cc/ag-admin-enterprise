...
public class MybatisDataInterceptor implements Interceptor {
    ...
    public Object intercept(Invocation invocation) throws Throwable {
        ...
        IsDeleted0 isDeleted0 = clazz.getAnnotation(IsDeleted0.class);
        IsDeleted1 isDeleted1 = clazz.getAnnotation(IsDeleted1.class);
        ...
        //查询is_deleted = 0
        if (isDeleted0 != null) {
            if (tenant == null && depart == null) {
                whereSql.append(" is_deleted = 0 ");
            } else {
                whereSql.append(" and is_deleted = 0 ");
            }
        ...
        if (isDeleted1 != null) {
            if (tenant == null && depart == null) {
                whereSql.append(" is_deleted = 1 ");
            } else {
                whereSql.append(" and is_deleted = 1 ");
            }
