...
public abstract class BaseBiz<M extends CommonMapper<T>, T> {
    ...
    public TableResultResponse<T> selectByQuery(Query query) {
        ...
        if ((null != query.getIsAsc() && !"".equals(query.getIsAsc())) && (null != query.getOrderByField() && !"".equals(query.getOrderByField()))) {
            example.setOrderByClause(query.getOrderByField() + " "+ query.getIsAsc());
        }
